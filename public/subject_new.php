...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($code) && $subjectModel->codeExists($code)) {
        ...
        if (empty($errors)) {
            if ($subjectModel->create($code, $title, $unit)) {
                Redirect::to('subject_list.php?msg=Subject added successfully');
            } else {
...
<head>
    ...
    <title>Add New Subject - School Encoding Module</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <p class="subtitle">Create a new subject in the system</p>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="unit" name="unit" value="<?php echo htmlspecialchars($formData['unit']); ?>" min="1" required>
            </div>
