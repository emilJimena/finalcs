...
<head>
    ...
    <title>Programs List - School Encoding Module</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <h1>Programs</h1>
        <p class="page-subtitle">Manage all programs in the system</p>
        ...
        <div class="action-bar">
            <form method="GET" class="search-box">
                ...
                <?php if (!empty($searchTerm)): ?>
                    <a href="program_list.php" class="btn" style="padding: 10px 16px; text-decoration: none;">Clear</a>
                <?php endif; ?>
            </form>

            <?php if (Auth::isAdminOrStaff()): ?>
                <a href="program_new.php" class="btn">+ Add New Program</a>
            <?php endif; ?>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="program_edit.php?id=<?php echo $program['program_id']; ?>" class="btn-small">Edit</a>
                                    <a href="program_delete.php?id=<?php echo $program['program_id']; ?>" class="btn-small btn-delete" onclick="return confirm('Are you sure?');">Delete</a>
                                </div>
                            </td>
                            <?php endif; ?>
                        </tr>
        ...
        <?php else: ?>
            <div class="empty-message">
                No programs found. <?php if (Auth::isAdminOrStaff()): ?><a href="program_new.php">Create one</a><?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
</body>
